// Function for reading binary file and store vlaues as floating points
#include "ioFunctions.h"

void io::readCalibrationData(const std::string filename, std::vector<std::string>& calibration_data)
{
	std::string line;
	char c = '=';
...
std::vector <float> io::readBinary(const std::string filename) {
	// Create the array in which store the binary file transformed in float numbers
